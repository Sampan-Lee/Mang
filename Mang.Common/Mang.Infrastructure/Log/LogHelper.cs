...
namespace Mang.Infrastructure
{
    public static class LogHelper
    {
        ...
        {
            new LogEventInfo() { Level = LogLevel.Trace, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
        ...
        {
            new LogEventInfo() { Level = LogLevel.Debug, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
        ...
        {
            new LogEventInfo() { Level = LogLevel.Error, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
        ...
        {
            new LogEventInfo() { Level = LogLevel.Info, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
        ...
        {
            new LogEventInfo() { Level = LogLevel.Warn, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
        ...
        {
            new LogEventInfo() { Level = LogLevel.Fatal, Message = message }.SetLogEventInfoProperties(logContent)
                .ToLog();
        }
