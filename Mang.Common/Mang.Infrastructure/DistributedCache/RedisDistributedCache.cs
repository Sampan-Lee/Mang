...
namespace Mang.Infrastructure.DistributedCache
{
    public class RedisDistributedCache : IDistributedCache
    {
        ...
        {
            _connenctionString =
                Appsettings.app(new string[] { "ConnectionStrings", "RedisConnectionString", "Host" }); //获取连接字符串

            _connenctionPwd = Appsettings.app(new string[]
                { "ConnectionStrings", "RedisConnectionString", "Password" }); //获取连接密码
