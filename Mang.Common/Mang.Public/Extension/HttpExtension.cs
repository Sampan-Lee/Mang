...
namespace Mang.Public.Extension
{
    public static class HttpExtension
    {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static async Task<T> PostAsync<T>(this HttpClient httpClient, string url, T param)
            where T : class
        {
            T result;
            try
            ...
            {
                //LogHelper.Error(ex, $"PostObjectAsync:出错");
        ...
        /// <returns></returns>
        public static async Task<List<T>> PostFormFileAsync<T>(this HttpClient httpClient, string url,
            IFormFileCollection formFile) where T : class
        {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static async Task<T> PutObjectAsync<T>(this HttpClient httpClient, string url, object param)
            where T : class
        {
            T result = default(T);
            try
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static async Task<T> DeleteBatchAsync<T>(this HttpClient httpClient, string url, object param)
            where T : class
        {
            T result = default(T);
            try
