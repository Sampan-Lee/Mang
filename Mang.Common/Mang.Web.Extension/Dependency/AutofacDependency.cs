...
using Mang.Infrastructure.AOP.Cacheable;
...
namespace Mang.Web.Extension.Dependency
{
    public class AutofacDependency : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var application = "Mang"; // Appsettings.app("Application");
            var servicesFile = Path.Combine(basePath, $"{application}.Application.dll");
            ...
            builder.RegisterType(typeof(TransactionAsyncInterceptor));
            ...
            var domainFile = Path.Combine(basePath, $"{application}.Domain.dll");
            // 获取 Service.dll 程序集服务，并注册
            ...
            var infrastructureFile = Path.Combine(basePath, "Mang.Infrastructure.dll");
            // 获取 Service.dll 程序集服务，并注册
